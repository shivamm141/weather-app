...
async function handleSearch() {
  ...
  elements.sidebarWind.textContent = `${data.windSpeed} km/h`;

  elements.feelsLike.textContent = `${Math.round(data.feelsLike)}°C`;

  elements.pressure.textContent = `${data.pressure} hPa`;
  elements.sidebarPressure.textContent = `${data.pressure} hPa`;

  elements.sidebarVisibility.textContent = `${data.visibility / 1000} km`;
